...
# from aibolit.schemas.users import UserCreateRequest, UserCreateResponse
from aibolit.schemas.openapi_generated import UserCreateRequest, UserCreateResponse
