...
# from aibolit.schemas.users.schemas import User, UserCreateRequest
from aibolit.schemas.openapi_generated.schemas import UserCreateResponse as User, UserCreateRequest
