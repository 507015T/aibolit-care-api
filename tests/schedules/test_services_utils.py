...
daily_plans = {
    ...
    12: "08:00,09:30,10:45,12:00,13:15,14:30,15:45,17:00,18:15,19:30,20:45,22:00",
    13: "08:00,09:15,10:30,11:30,12:45,14:00,15:00,16:15,17:30,18:30,19:45,21:00,22:00",
    14: "08:00,09:15,10:15,11:15,12:30,13:30,14:30,15:45,16:45,17:45,19:00,20:00,21:00,22:00",
    15: "08:00,09:00,10:00,11:00,12:00,13:00,14:00,15:00,16:00,17:00,18:00,19:00,20:00,21:00,22:00",
}
daily_plans_data = [(frequency, daily_plan.split(",")) for frequency, daily_plan in daily_plans.items()]

round_to_next_interval_data = [
...
@pytest.mark.parametrize("frequency, expected_result", daily_plans_data)
...
@pytest.mark.parametrize("input_dt, expected_dt", round_to_next_interval_data)
...
@pytest.mark.parametrize("now_time, dose_time, expected", is_within_timeframe_data)
